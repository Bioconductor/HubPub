...
date: "Modified: Mar 2025. Compiled: `r format(Sys.Date(), '%d %b %Y')`"
output:
...
temporary access to S3 directory where you can upload your data for preprocessing. 
...
metadata.csv file will need to be created in the git/github repository for your
package.
