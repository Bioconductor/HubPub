...
upload to see what uploaded correctly and what is missing.
...
steps.
  ...
  name. And insert the given <sas url> into the Blob container SAS URL
...
a outlet plug on the far left to launch the resource connection windows (the see 
beginning of GUI section for connecting to resource)
...
pane.
  ...
  URL by clicking on the picture that looks like an outlet plug in the far left. 
