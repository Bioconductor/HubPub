...
For data that is currently being stored remotely, use `copy_url_to_storage` or
...
steps. Screenshots provided after.
...
![SelectBlobContainer](StorageExplorerScreenShots/SelectBlobContainer.png)
